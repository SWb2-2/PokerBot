...
function ai(game_data, player_data) {
	let ai_move;
	let current_round = "";
	let available_moves = [];
	...
	ai_move = calculate_move(available_moves, equity, current_round, move_history, player_data, game_data);
...
function determine_move(equity, player_data, game_data, current_round) {
	let EV_check = 0;
	let EV_raise = 0;
	let EV_call  = 0;
	const EV_fold  = 0;
