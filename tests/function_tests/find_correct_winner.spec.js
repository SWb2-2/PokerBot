...
describe("Check if winner is correctly found", () => {
    ...
    test("Best hand is 'One Pair'", () => {
        ...
        let human_player = new Player(balance, "player");
        human_player.hand = [new Card(14,2), new Card(3,2)];

        let ai_player = new Player(balance, "robot");
        ai_player.hand = [new Card(2, 2), new Card(13,1)];
        ...
        expect(winner.winner).toBe(human_player.name);
    ...
    test("Best hand is 'Straight'", () => {
        ...
        let dealer_here = new Dealer();
        dealer_here.table_cards = [new Card(12,1), new Card(5,3), new Card(4, 1), new Card(3,0), new Card(2,0)];
    ...
    test("Best hand is 'Full House'", () => {
        ...
        let dealer_here = new Dealer();
        dealer_here.table_cards = [new Card(2,1), new Card(14,3), new Card(9, 1), new Card(14,0), new Card(13,0)];

        const winner = dealer_here.get_winner(human_player, ai_player);

        expect(winner.winner).toBe(ai_player.name);
        expect(winner.human_hand).toBe("two pairs");
        expect(winner.ai_hand).toBe("full house");
    });
    ...
    test("Best hand is 'Straight Flush'", () => {
        ...
        let dealer_here = new Dealer();
        dealer_here.table_cards = [new Card(12,1), new Card(11,1), new Card(14, 1), new Card(10,1), new Card(5,0)];
